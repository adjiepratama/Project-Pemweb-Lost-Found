        ...
        <aside class="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col justify-between">
            <div>
                ...
                <nav class="mt-6 px-4 space-y-1">
                    ...
                    <a href="{{ route('user.lapor') }}" class="flex items-center gap-3 px-4 py-3 text-cyan-600 bg-cyan-50 rounded-lg font-medium transition-colors">
        ...
        <div class="flex-1 flex flex-col overflow-hidden relative">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-8">
                ...
                <div class="max-w-4xl mx-auto">
                    <h2 class="text-2xl font-bold text-gray-800 mb-2">Lapor Barang Hilang</h2>
                    ...
                    <form action="{{ route('user.lapor.store') }}" method="POST" enctype="multipart/form-data"> 
                        ...
                        <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label class="block text-gray-700 text-sm font-bold mb-2">No Induk</label>
                        ...
                        <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm mb-6">
                            ...
                            <div>
                                ...
                                <select name="location" class="block w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-sm text-gray-600 focus:outline-none focus:ring-2 focus:ring-cyan-500" required>
                                ...
                                <p class="text-[10px] text-gray-400 mt-1">*Pilih area utama. Detail ruangan bisa ditulis di deskripsi.</p>
                            </div>
